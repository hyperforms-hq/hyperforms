...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  createWorkspace?: Resolver<Maybe<ResolversTypes['Workspace']>, ParentType, ContextType, RequireFields<MutationCreateWorkspaceArgs, 'workspace'>>,
};
...
export const CreateWorkspaceDocument = gql`
  ...
  createWorkspace(workspace: {displayName: $name}) {
    displayName
  }
}
    `;
...
export type CreateWorkspaceProps<TChildProps = {}> = ApolloReactHoc.MutateProps<CreateWorkspaceMutation, CreateWorkspaceMutationVariables> & TChildProps;
export function withCreateWorkspace<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  CreateWorkspaceMutation,
  CreateWorkspaceMutationVariables,
  CreateWorkspaceProps<TChildProps>>) {
    return ApolloReactHoc.withMutation<TProps, CreateWorkspaceMutation, CreateWorkspaceMutationVariables, CreateWorkspaceProps<TChildProps>>(CreateWorkspaceDocument, {
      alias: 'withCreateWorkspace',
      ...operationOptions
    });
};
