...
export type CreateWorkspaceMutation = { __typename?: "Mutation" } & {
  createWorkspace: Maybe<
    { __typename?: "Workspace" } & Pick<Workspace, "displayName">
  >;
};
...
export type GetWorkspacesQuery = { __typename?: "Query" } & {
  workspaces: Array<
    { __typename?: "Workspace" } & Pick<Workspace, "urlKey" | "displayName">
  >;
};
...
>;
export type CreateWorkspaceComponentProps = Omit<
...
export const CreateWorkspaceComponent = (
  props: CreateWorkspaceComponentProps
) => (
...
export type CreateWorkspaceProps<TChildProps = {}> = ApolloReactHoc.MutateProps<
  CreateWorkspaceMutation,
  CreateWorkspaceMutationVariables
> &
  TChildProps;
export function withCreateWorkspace<TProps, TChildProps = {}>(
...
`;
export type GetWorkspacesComponentProps = Omit<
...
export const GetWorkspacesComponent = (props: GetWorkspacesComponentProps) => (
  <ApolloReactComponents.Query<GetWorkspacesQuery, GetWorkspacesQueryVariables>
    query={GetWorkspacesDocument}
    {...props}
  />
);

export type GetWorkspacesProps<TChildProps = {}> = ApolloReactHoc.DataProps<
  GetWorkspacesQuery,
  GetWorkspacesQueryVariables
> &
  TChildProps;
export function withGetWorkspaces<TProps, TChildProps = {}>(
  operationOptions?: ApolloReactHoc.OperationOption<
    TProps,
    GetWorkspacesQuery,
    GetWorkspacesQueryVariables,
